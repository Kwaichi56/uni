# Структура лабораторной работы 11
...
- `SportNutritionShop/ViewModels/LoginViewModel.cs` и `ProfileViewModel.cs` —
  состояние входа, профиля и команды окон.
- `SportNutritionShop/ViewModels/MainViewModel.cs` — каталог, корзина,
  сохранённые корзины, фильтры и навигационные команды.
...
- `Answers_Lab11.md` — ответы на вопросы MVVM; `Answers_Lab10.md` сохранён
  как материал предыдущей лабораторной работы.
