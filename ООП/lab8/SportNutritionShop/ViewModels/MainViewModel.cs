...
namespace SportNutritionShop.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public SavedCart? SelectedSavedCart { get => _selectedSavedCart; set { _selectedSavedCart = value; OnPropertyChanged(); } }
        ...
        // ===== Сохранение / загрузка корзины (для RoutedUICommand SaveCartCommand) =====
